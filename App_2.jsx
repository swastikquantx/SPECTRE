  ...
  return (
    <div style={{background:"#0a0a0a", color:"#e5e5e5", minHeight:"100vh", fontFamily:"monospace", padding:24}}>
      <div style={{display:"flex", alignItems:"center", gap:16}}>
        <img src="/spectre_logo.webp" alt="SPECTRE" style={{width:52, height:52, filter:"invert(1) brightness(2)"}} />
        <h1 style={{fontSize:32, letterSpacing:2, margin:0}}>SPECTRE</h1>
        <span style={{fontSize:12, letterSpacing:6, color:"#00FFD1", border:"1px solid #00FFD1", padding:"4px 10px", borderRadius:4, marginLeft:8, fontWeight:"bold"}}>LETS BUILD</span>
      </div>
